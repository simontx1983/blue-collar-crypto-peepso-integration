<?php
/**
 * Tab: NFT Block – server-side render.
 *
 * Reuses the existing NFT dashboard template within a block wrapper.
...
if ( ! is_user_logged_in() ) {
    echo '<p>' . esc_html__( 'Please log in to view this NFT profile.', 'blue-collar-crypto' ) . '</p>';
    return;
}
...
$template = BCC_TEMPLATES_PATH . 'peepso/dashboard/nft.php';
